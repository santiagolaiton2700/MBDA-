...
BEGIN
PC_ACCIDENTES.AD_ACCIDENTES(0,'CHOQUELATERAL', 'DAÃODEPUERTASYVENTANAS', 1000, 100000, TO_DATE('20/12/1998','DD/MM/YYYY'),'');
END;
...
BEGIN
PC_POLIZAS.AD_POLIZAS(TO_DATE(1, TO_DATE('13/11/2015','DD/MM/YYYY'), '13/11/2018','DD/MM/YYYY'), 366, 0);
END;
