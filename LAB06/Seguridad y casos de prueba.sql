...
DECLARE 
    a SYS_REFCURSOR;
BEGIN
    SELECT PC_CARRERAS.CO_NOMBRE('123ABBBBBBBBBBBBBBBB') INTO a FROM dual;
END;
/
...
DECLARE 
    a SYS_REFCURSOR;
BEGIN
    SELECT PC_CARRERAS.CO_CARRERA() INTO a FROM dual;
END;
/


SELECT PC_CARRERAS.CO_NOMBRE('123ABBBBBBBBBBBBBBBB')
FROm dual;
