...
CREATE OR REPLACE PACKAGE BODY PC_REGISTROS IS
    ...
    WHEN OTHERS THEN
    ROLLBACK;
    RAISE_APPLICATION_ERROR(-20018,'NO SE PUEDE INSERTAR');
    END;
    ...
    WHEN OTHERS THEN
    ROLLBACK;
    RAISE_APPLICATION_ERROR(-20019,'NO SE PUEDE MODIFICAR');
    END;
...
CREATE OR REPLACE PACKAGE PA_ADMINISTRADOR IS
    PROCEDURE AD_MIEMBRO(xid in number,xIDT in varchar, xIdn in NUMBER,xPais IN VARCHAR,xCorreo IN VARCHAR);
...
CREATE OR REPLACE PACKAGE BODY PA_ADMINISTRADOR IS
    PROCEDURE AD_MIEMBRO(xid in number,xIDT in varchar, xIdn in NUMBER,xPais IN VARCHAR,xCorreo IN VARCHAR)IS
    BEGIN
        INSERT INTO MIEMBRO(ID,IDT,IDN,PAIS,CORREO)VALUES(xID,xIDT,xIDN,xPAIS,xCORREO);
    COMMIT;
    EXCEPTION
    WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20020,'NO SE PUEDE INSERTAR');
    END;
    ...
    WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20021,'NO SE PUEDE INSERTAR');
    END;
    ...
    WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20022,'NO SE PUEDE INSERTAR');
    END;
    ...
    WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20023,'NO SE PUEDE INSERTAR');
    END;
    ...
    WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20024,'NO SE PUEDE ACTUALIZAR');
    END;
    ...
    WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20025,'NO SE PUEDE ACTUALIZAR');
    END;
    ...
    WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20026,'NO SE PUEDE ACTUALIZAR');
    END;
    ...
    WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20027,'NO SE PUEDE ACTUALIZAR');
    END;
    ...
    WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20028,'NO SE PUEDE ELIMINAR');
    END;
    ...
    WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20029,'NO SE PUEDE ELIMINAR');
    END;
    ...
    WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20030,'NO SE PUEDE ELIMINAR');
    END;
    ...
    WHEN OTHERS THEN
        ROLLBACK;
        RAISE_APPLICATION_ERROR(-20031,'NO SE PUEDE ELIMINAR');
    END;
