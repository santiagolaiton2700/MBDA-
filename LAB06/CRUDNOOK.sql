...
/
BEGIN
PC_REGISTROS.AD_REGISTRO(2,TO_DATE('29/09/2019','dd/mm/yyyy'),401111111,1,'BIEN','M','www.MONTAÑA.PDF','NO HUBO ACCIDENTE');
END;
/
BEGIN
PC_REGISTROS.AD_REGISTRO(3,TO_DATE('30/09/2019','dd/mm/yyyy'),305555555,1,'BIEN','B','www.MONTAÑA.GIF','NO ACCIDENTES');
END;
/
------------------CICLISTA---------------------------------------------------
