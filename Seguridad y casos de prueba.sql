...
BEGIN 
PC_CARRERAS.AD_CARRERA('123ABBBBBBBBBBBBBBBA','TOUR F','FRANCIA',2,'ANUAL', '201CO');
END;
/*
-------Nikolai modifica la carrera que anadio anteriormente--------
BEGIN 
PC_CARRERAS.MOD_CARRERA('123ABBBBBBBBBBBBBBBB','TOUR F','FRANCdIA',1,'SEMESTRAL', '201CO');
END;
*/
...
/
BEGIN
PC_REGISTROS.MOD_REGISTRO(207777777,1,'BIEN','A','www.MONTANA.PDF','NO HUBO ACCIDENTES');
END;
/
